...
| Mortal Kombat: Deception (`SLUS_208.81`) | Retail | **MENU YES** | Soft-GS midway-menu (p2qws≈5988). Residual: INTERACTIVE idle-pad + gameart GIF IMAGE (G-GFX-3). See `docs/title-ports/MK_DECEPTION.md`. |
