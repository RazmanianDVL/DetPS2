...
public sealed class EmotionEngine
{
    ...
    private int ExecuteSyscall(uint opcode, ref ulong nextPC)
    {
        ...
        switch (syscallNumber)
        {
            ...
            case 0x20: case 0x21: case 0x22: case 0x23: case 0x24: case 0x25: case 0x26: case 0x30: case 0x40:
            case 0x50: case 0x60: case 0x61: case 0x70: case 0x71:
            case 0x80: case 0x81: case 0x90: case 0x91: case 0xA0: case 0xA1: case 0xB0: case 0xB1: case 0xC0:
                _gprs[2].Lo = 0;
                break;
