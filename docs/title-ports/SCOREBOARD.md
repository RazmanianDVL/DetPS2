...
| **MK Deadly Alliance** | SLUS_204.23 | **YES** (midway-menu) | px=47696645 prims=8799 gifP2=606 XYZ2=6366 exitReq=False | S0 tip re-claim; residual INTERACTIVE pad + FRONTEND chrome (fail-tails held) |
