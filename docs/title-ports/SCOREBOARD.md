...
| **MK Deception** | SLUS_208.81 | **YES** (midway-menu) | px≈22M p2qws=5988 gifP3=6 **imgBytes=557056** gameart=2.8MB INTERACTIVE | PL-029 Host→Local SEC tiles; natural EE IMAGE residual |
