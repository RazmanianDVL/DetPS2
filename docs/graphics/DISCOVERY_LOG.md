# Graphics discovery log

Append-only. When pad/menu advances and Soft-GS shows a **new** wall, add a row.

| Date | Title | Metric | Wall | Owner seat | WP |
|------|-------|--------|------|------------|-----|
| 2026-07-31 | (baseline) | MENU 9/9 | expand strips / assist PATH3 / composite-only residual | S8–S10 | G0 |
...
| 2026-07-31 | BO2 | title-FB pad opens=2 inject≈1536; gifP2=54 prims=1 | pad DMA live; no sel-idx; IMAGE multi-prim residual | S5 | PL-015 |
...
<<<<<<< HEAD
| 2026-07-31 | shared/B3 | GX-041 natural DISPFB→output; circuit-gen invalidate; residualDispfbPx + compositeSource; G3 Y vs Y? | **B3 diagnose@20M:** DISPFB1=0 but **DISPFB2 natural** (pmode EN2, circ=2) → naturalDispfbPx=184320 G3=Y compositeSource=NaturalDispfb; no plant. FRAME/FBP0 residual path remains when both DISPFB raw=0 (`G3=Y?`). MK@20M dispfb=0 G3=N | S10 | PL-025 / GX-041 |
=======
| 2026-07-31 | fleet | G2 Host→Local IMAGE + TEX sample | PSMCT32/16/24 + PSMT8/4; CLUT via TEX0.CLD; TBW swizzle; TEXA; L2L; procedural off when TEX0 valid; expandHits hold | S9 | GX-025…035 |
>>>>>>> origin/agent/seat-s9/s2-g2
