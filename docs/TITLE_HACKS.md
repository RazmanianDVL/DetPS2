...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — w10: real 0x27DBF0 force+hang-escape; refuse 989snd stomp of LoadWad streamObj; protect GIF DMA tag builders 0x13F5xx; no mid-pack Refresh; Path3MaskedByVif held | cdvd=1202 gifP2=1082 **px=0 FRAME_1=0** dbf0Esc=1 shell decode residual | 2026-07-31 |
