...
|----------|--------|------|--------|------|
| Mortal Kombat: Shaolin Monks (USA) | SLUS_210.87 | MidwayBootAssist — Wave-6: type=1+method stub; force BFC0 (not 26FBF0); patch 43AB88→arena obj; C1C0 soft-complete; trampoline HLE-scratch protect; slot re-seal; no type5. | C1C0 bind YES; slot0+obj held; FAE8 wk fires; gifP3=11 NEAR; second-chrome Path3 open | 2026-07-31 |
