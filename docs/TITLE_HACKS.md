...
| Mortal Kombat: Deadly Alliance (USA) | `SLUS_204.23` | `MidwayFamilyAssist` **DA**: MFL gameart bridge; display-lock escape; WAVE-6 post-logo **fail-tail plants** + keep-alive (no WaitSema fabricate; no invent Soft-GS) | **MENU YES** midway-menu; S0 tip px=47.7M prims=8799 XYZ2=6366; residual INTERACTIVE pad + FRONTEND chrome | 2026-07-31 |
