...
| Blood Omen 2 (USA) | `SLUS_200.24` | `BloodOmen2SnAssist` — SN stubs, IOPRP `"2340"`, real BG2, **goefile member extract** (.IMP/.ETP), format leaf @0x482F60, InMap escape, post-entity bit-pack leave; **no** fake CODE/MAINMENU sectors | pack-member KAIN.IMP OK; #17 no game CODE/MAINMENU Open; px=3 (#8) | 2026-07-31 |
