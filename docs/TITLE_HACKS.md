...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — IOPRP `"3000"`; **wave-8b** KernelHle classic StartThread resume (Haven $ra-resume broke GoW boot); type-2 FULL stream natural success (v0=2 + digit/fill); PART1/TOC FILEIO + R_SHELL/TIT1; Path3MaskedByVif held | **cdvd=555**; type-2 **resWas=0 epi**; gifP2=962 gifP3=0; **MENU NO** px=0 FRAME_1=0 | 2026-07-31 |
