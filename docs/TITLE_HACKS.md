...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — w10b: streamObj magic 0x100; slot+0x170 follow bound; 0x27D7C8 soft-ok; SavedPc pin fill→0x27DBF0; hang-guard; Path3MaskedByVif held | cdvd=1202 gifP2=1082 **px=0 FRAME_1=0** prims=0 shell decode residual | 2026-07-31 |
