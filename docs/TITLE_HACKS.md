...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — IOPRP `"3000"`, FreezeCache, BST/freelist soft escapes; wave-5 real-thread type-2; **wave-6** poison-SP repair, word-scan 0x299354 escape, type-2 gate stubs + complete-once, no mid-body force-rewind; Path3MaskedByVif held | CDVD 142 IRX-only; gifPath2=962 gifPath3=0; type-2 soft-ok; still px=0 FILEIO/LoadWad | 2026-07-31 |
