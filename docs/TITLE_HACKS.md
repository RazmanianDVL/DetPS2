...
| Mortal Kombat: Deception (USA) | `SLUS_208.81` | `MidwayFamilyAssist` **DEC** — idle force-process + gameart.ssf path-hash/publish + PowerOff storm→keep-alive; no invent PATH3; Path3MaskedByVif held | **midway-menu MENU YES** p2qws=5988 px≈22M gifP3=6; residual **INTERACTIVE** idle-pad + **IMAGE** gameart TEX (G-GFX-3) | 2026-07-31 |
