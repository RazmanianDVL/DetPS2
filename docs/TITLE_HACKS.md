...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — type-2 FULL stream + fill `0x27E0CC` (w9 streamPast); LoadWad bind Fedo R_SHELL restored; classic StartThread; Path3MaskedByVif held | cdvd=692; streamPast=True; **px=0 gifP3=0 FRAME_1=0** residual | 2026-07-31 |
