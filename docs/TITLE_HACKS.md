...
| Burnout 3: Takedown (USA) | `SLUS_210.50` | `Burnout3Assist` + **`HandleLgDev`** + **DBC SetWorkAddr paint** (`work=0x0067CCC0`); residual→STG; FRONTEND 4MiB plant; Soft-GS merge composite; logo edge pad | STG+TXD+FRONTEND cdvd=6584 **px≈23.6M** prims=4954 **logo-frontend MENU YES**; DBC paints≥1588; INTERACTIVE residual | 2026-07-31 |
