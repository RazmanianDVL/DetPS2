...
| Whiplash (USA) | `SLUS_206.84` | `WhiplashAssist` — MENU-WHIP-2 Host→Local GOE firstscreen + ofx expand | Soft-GS lit=5189 Host→Local residual — **not natural MENU YES** | 2026-07-31 |
