...
| God of War (USA) | `SCUS_973.99` | `GodOfWarAssist` — w9b: pre-type2 full Fedo R_SHELL + LoadWad seed; real 0x27DBF0 hang-guard (no permanent soft-ok); force epi+hold; SignalSema wake (no type-3 invent); Path3MaskedByVif held | cdvd=1202 gifP2=1082 **px=0 FRAME_1=0** prims=0 shell decode residual | 2026-07-31 |
